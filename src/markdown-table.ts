export type TMarkdownAlign = string | Array<string | null | undefined> | null | undefined
/**
...
export function markdownTable(
    ...
    const align: TMarkdownAlign = (options.align || []).concat()
...
function toAlignment(value: string | null | undefined): number {
    const code: number | undefined = typeof value === 'string' ? value.codePointAt(0) : 0
